...
import '../models/arabic_surah_model.dart';
...
Future getSettings() async {
  try {
    final prefs = await SharedPreferences.getInstance();
    arabicFontSize = prefs.getDouble('arabicFontSize') ?? 18.9;
    mushafFontSize = prefs.getDouble('mushafFontSize') ?? 22.9;
  } catch (_) {
    arabicFontSize = 28;
    mushafFontSize = 40;
  }
...
List<Map<String, String>> arabicName = [
...
Future readJson() async {
  ...
  final quranarabicName = arabicNameFromJson(jsonString).quran;
